...
vim.keymap.set("n", "<leader>df", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>", { desc = "Buffer Diagnostics (Trouble)" })
...
vim.keymap.set("n", "<leader>ql", "<cmd>Trouble qflist toggle<cr>", { desc = "Quickfix List (Trouble)" })
